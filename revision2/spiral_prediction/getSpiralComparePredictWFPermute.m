function getSpiralComparePredictWFPermute(T,data_folder,save_folder)
...
predict_folder = fullfile(data_folder,'revision2','spirals_wf_scrambled');
...
for kk = 1:size(T,1)
    ...
    clear pwAll
    T2 = readtable(fullfile(data_folder,'revision2','spirals_wf_scrambled',...
