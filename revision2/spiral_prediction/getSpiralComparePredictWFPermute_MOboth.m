function getSpiralComparePredictWFPermute_MOboth(T,data_folder,save_folder)
...
predict_folder = fullfile(data_folder,'revision2','MO_predict','spirals_permute_MO_both');
...
for kk = 1:size(T,1)
    ...
    clear pwAll
    T2 = readtable(fullfile(data_folder,'revision2','MO_predict','spirals_permute_MO_both',...
...
%%
save(fullfile(save_folder,'spiral_compare_sessions_neighbor_perm.mat'),...
