function [soma_center,axon_vector, angle1, polarity,axon_length] = getAxonSVD2(axon_terminal_all,soma_all)
...
for icell = 1:cell_n
    ...
    %% project axons to pc1
    pc1 = axon_current_2d*U(:,1);
    axon_length(icell,1) = max(pc1)-min(pc1);
end
