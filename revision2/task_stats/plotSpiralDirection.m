function h3 = plotSpiralDirection(data_folder,save_folder)
%%
...
%%
print(h2,'CW_ipsi_ratio_pre.pdf','-dpdf', '-bestfit', '-painters');
%%
pre_mean2 = mean(pre_mean_all,1);
pre_sem2 = std(pre_mean_all,1)./sqrt(4);
post_mean2 = mean(post_mean_all,1);
post_sem2 = std(post_mean_all,1)./sqrt(4);
for k = 1:3
...
%%
print(h2,'CW_ipsi_ratio_post3.pdf','-dpdf', '-bestfit', '-painters');