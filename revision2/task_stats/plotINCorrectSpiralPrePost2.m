function hs15j = plotINCorrectSpiralPrePost2(data_folder,save_folder)
...
hist_bin = 40;
%%
load(fullfile(data_folder,'task','spirals','IncorrectSpiralsPrePost2.mat'));
%%
...
%%
print(hs15j, fullfile(save_folder,'FigS15j_task_spirals_incorrect_pre_post2'), ...
