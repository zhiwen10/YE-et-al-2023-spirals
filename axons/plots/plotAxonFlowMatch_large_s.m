function hs10f = plotAxonFlowMatch_large_s(T,data_folder,save_folder)
...
T1 = readtable(fullfile(data_folder,'axons','Axon_bias_all_cells_SSp2.csv'));
...
%%
center = [350,700]; % PPC
hs10f = figure('Renderer', 'painters', 'Position', [100 100 900 400]);
ax1 = subplot(1,3,1);
x1 = linspace(-90,90,180);
...
print(hs10f, fullfile(save_folder,'FigS10f_axon_flow_match_large.pdf'),...
