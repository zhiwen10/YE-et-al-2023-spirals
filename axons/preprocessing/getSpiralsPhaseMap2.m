function getSpiralsPhaseMap2(T,data_folder,save_folder)
...
for kk = 1:15
    ...
    filteredSpirals1 = filteredSpirals(filteredSpirals(:,3)>=100,:);
    filteredSpirals1 = filteredSpirals1(filteredSpirals1(:,4)==1,:);
    location_index = (filteredSpirals1(:,1)>=750 &...
        filteredSpirals1(:,1)<=850 & ...
        filteredSpirals1(:,2)>=600 &...
        filteredSpirals1(:,2)<=800);
    ...
    %
    save(fullfile(save_folder,[fname '_mean_flow_large']),...
