function [count1]= plot_single_pixel3(ops,sp,mean_var_t, mimgt,mimg, BW1, point, point_t,...
...
subplot(3,4,[2:4])
% trace_predict = squeeze(data_predict.trace2d1(:,point1(1,1),point1(1,2)))./mimg_scale(point1(1,1),point1(1,2));
% trace_raw = squeeze(data_raw.trace2d1(:,point1(1,1),point1(1,2)))./mimg_scale(point1(1,1),point1(1,2));
