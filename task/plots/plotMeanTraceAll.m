function hs15ace = plotMeanTraceAll(data_folder,save_folder)
...
%%
hs15ace = figure('Renderer', 'painters', 'Position', [100 100 800 300]);
ax1 = subplot(1,4,1);
...
print(hs15ace,fullfile(save_folder,'FigS15ace_task_mean_trace.pdf'),'-dpdf', '-bestfit', '-painters');