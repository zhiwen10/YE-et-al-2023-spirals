...
for i = 1:4
    ...
    %% left stim
        ...
        for n = 1:141
            ...
            spiral_Lstim_contra(n,1) = sum(indx1)./trialN1;
            indx2 = (spiral_temp(:,1) < 570 & spiral_temp(:,3)==100);
            spiral_Lstim_ipsi(n,1) = sum(indx2)./trialN1;
        end
        %% right stim
        clear index spiral_cell_temp spiral_cell_temp2
        ...
        for n = 1:141
            ...
            spiral_temp =  spiral_cell_temp2{n};
            indx1 = (spiral_temp(:,1) < 570 & spiral_temp(:,3)==100);
            spiral_Rstim_contra(n,1) = sum(indx1)./trialN2;
            indx2 = (spiral_temp(:,1) > 570 & spiral_temp(:,3)==100);
            spiral_Rstim_ipsi(n,1) = sum(indx2)./trialN2;
        end
        %%
        spiral_contra(:,i,kk) = (spiral_Lstim_contra+spiral_Rstim_contra);
        spiral_ipsi(:,i,kk) = (spiral_Lstim_ipsi+spiral_Rstim_ipsi);
    end
    %%
    kk = 3;
    clear index spiral_cell_temp spiral_cell_temp2
...
%%
spiral_count_sum(:,:,3) = spiral_count_sum_miss*35;
%%
