function hs15i = plotPassiveSpiralPrePost(data_folder,save_folder)
...
load(fullfile(data_folder,'task','spirals','PassiveSpiralsPrePost.mat'));
%%
hs15i = figure('Renderer', 'painters', 'Position', [100 100 800 800]);
for j =1:2
...
%%
print(hs15i, fullfile(save_folder,'FigS15i_passive_spirals_pre_post'), ...
