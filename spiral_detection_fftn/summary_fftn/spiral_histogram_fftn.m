...
%%
spiral_folder = 'C:\Users\Steinmetz lab\Documents\MATLAB\widefield_DIY\phase\spiralDetectionfftn\fftn_control';
...
save(['histogram_control_' num2str(hist_bin) 'pixels.mat'], 'unique_spirals');
%%
pixSize = 0.01; % mm/pix
pixArea = pixSize^2;
...
for radius = 10:10:100
    ...
    save(['histogram_control_radius_' num2str(radius) '.mat'], 'unique_spirals');
end