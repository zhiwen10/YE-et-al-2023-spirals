function [trace2d,traceAmp,tracePhase] = spiralPhaseMap_fftn2(U1,dV1,t,params,rate)
...
%%
data_fft = fftshift(fftn(meanTrace)); % 3D fourier transform ??????
...
data_temp = ifftshift(data_fft_new);
meanTrace1 = real(ifftn(data_temp)) ; % 3D inverse fourier tranform
