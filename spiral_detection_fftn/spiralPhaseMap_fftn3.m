function [trace2d,traceAmp,tracePhase] = spiralPhaseMap_fftn3(U1,dV1,t,params,rate)
...
mag = abs(data_fft) ;
data_fft_new = mag.*exp(1i*phase);
data_temp = ifftn(data_fft_new);
meanTrace1 = real(data_temp) ; % 3D inverse fourier tranform
