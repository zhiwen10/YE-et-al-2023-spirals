function hs1d = plotExamplePowerSpectrum2(T,data_folder,save_folder)
...
hs1d = figure('Renderer', 'painters', 'Position', [100 100 700 300]);
for kk = 1:size(T,1)
    %% session info
    mn = T.MouseID{kk};
    tda = T.date(kk);
...
print(hs1d, fullfile(save_folder,'FigS1d_example_fft_all'),'-dpdf', '-bestfit', '-painters');
