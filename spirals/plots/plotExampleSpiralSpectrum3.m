function [hs1i2] = plotExampleSpiralSpectrum3(T,data_folder,save_folder)
...
hs1i2 = figure('Renderer', 'painters', 'Position', [100 100 300 600]);
subplot(1,1,1);
...
ylim([-7,-3]);   
%%
print(hs1i2,fullfile(save_folder, 'FigS1i2_example_time_series_spectrum.pdf'),...
