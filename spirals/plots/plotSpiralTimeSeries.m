...
% imH1Raw4 = quiver(col,row,vx,vy,'k','lineWidth',1,'autoScale','off');
...
axis off;
hold on;
imH1Raw4 = quiver(vxRaw2(a:b,c:d),vyRaw2(a:b,c:d),'k','lineWidth',1,'autoScale','off');
cb5 = colorbar(ax5);
pos5 = cb5.Position;
