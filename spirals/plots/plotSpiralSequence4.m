function h1b = plotSpiralSequence4(data_folder,save_folder)
...
load(fullfile(data_folder,'tables','mask_ZYE12_2.mat'));
%% registration
...
ax4 = subplottight(4,subplotn,13);
im_raw = imagesc(dff(:,:,frame));
colormap(ax3, parula)
axis image; axis off;
set(im_raw, 'AlphaData', BW2, 'AlphaDataMapping', 'scaled');
...
colorbar
%%
print(h1b, fullfile(save_folder,'Fig1b_example_spiral_sequence5.pdf'),...
