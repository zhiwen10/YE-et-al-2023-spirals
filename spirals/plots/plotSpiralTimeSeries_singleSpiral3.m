function h1ac = plotSpiralTimeSeries_singleSpiral3(data_folder,save_folder)
...
example_frame_to_plot = first_frame+3;
...
v = [100 60; 130 60;130,100;100 100];
f = [1,2,3,4];
...
set(ax2,'YTickLabel',[]);
for i = 1:7
    text(t1(1)-0.8,(i-1)*3,nameList{i},'Color', color2(i+2,:),'Interpreter','None');
end
xlabel('Time (s)','fontSize',9);
line_ax1 = xline(qt(first_frame1),'--');
line_ax2 = xline(qt(last_frame1),'--');
hold on;
plot([t1(1)+0.5,t1(1)+0.5],[0,1],'r');

%
framea_zoom = framea(60:100,100:130);
ax5 = subplot(2,2,4);
hold off;
...
axis off;
hold on;
imH1Raw4 = quiver(vxRaw2(60:100,100:130),vyRaw2(60:100,100:130),'k','lineWidth',1,'autoScale','off');
cb5 = colorbar(ax5);
pos5 = cb5.Position;
cb5.Position = [pos5(1)+0.1, pos5(2),pos5(3),pos5(4)/2];
%%
print(h1ac,fullfile(save_folder, 'Revision_example_time_series&flow_single.pdf'),...
