function [trace2d,traceAmp,tracePhase] = spiralPhaseMap_freq2(U,dV,t,params,freq,rate,mimg)
...
meanTrace = filtfilt(f1,f2,meanRaw);
%%
...
trace2d = reshape(meanRaw,tsize,x,y);
%%
