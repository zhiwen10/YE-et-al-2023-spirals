function h1b = plotSpiralSequenceFull(data_folder,save_folder)
...
for k = 1:frames
    ...
    ax4 = subplottight(4,subplotn,frames+k);
...
%%
print(h1b, fullfile(save_folder,'Fig1b_example_spiral_sequence_full.pdf'),...
