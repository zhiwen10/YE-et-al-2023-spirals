function hs1e = plotPowerRatio3(data_folder,save_folder)
%%
...
color2(3,:) = color1(2,:);
%%
hs1e = figure('Renderer', 'painters', 'Position', [100 100 300 300]);
index = ones(1,15);
for i = 1:4
...
%%
print(hs1e, fullfile(save_folder,'FigS1e_2-8hz_power_ratio'),...
