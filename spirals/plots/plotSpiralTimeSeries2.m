function h1ac = plotSpiralTimeSeries2(data_folder,save_folder)
...
hold on;
scatter(ax1,pixel(:,2),pixel(:,1),16,color2(3:10,:),'filled');
hold on;
...
%%
print(h1ac,fullfile(save_folder, 'Fig1ac_example_time_series&flow.pdf'),...
