function getSpiralDetectionFftnPermute(T,freq,data_folder,save_folder)
...
for kk = 1:size(T,1)
    ...
    %%
    [pwAll] = spiralDetectionAlgorithmFftn(U1,dV,t,params,freq,rate);      % same detection algorithm with FFTN
    pwAll1 = pwAll;
    pwAll1(:,1) = roi_ml(1)+pwAll1(:,1)-1;
    pwAll1(:,2) = roi_ap(1)+pwAll1(:,2)-1;
    frame_count = numel(t);
    save(fullfile(save_folder,freq_folder,'fftn',[fname '.mat']), ...
