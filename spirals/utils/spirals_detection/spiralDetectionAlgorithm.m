function [pwAll] = spiralDetectionAlgorithm(U1,dV,t,params,freq,rate) 
pwAll = [];
for kkk = 1:numel(params.frameRange)-1                                     % loop through batchs of frames
    ...
    t1 = t(frameTemp);
    [trace2d1,traceAmp1,tracePhase1] = ...                                 % filter data at a pre-defined frequency range
        spiralPhaseMap_freq(U1,dV1,t1,params,freq,rate);
