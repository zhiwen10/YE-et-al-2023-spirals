function h3j = plotKernelMapsAP(data_folder,save_folder)
...
for i = 1:8
    intensity_all1(:,:,i) = imresize(...
        squeeze(intensity_all(:,:,i)),size(TheColorImage_all,[1,2]));
    injection_intensity1(:,:,i) = imresize(...
        squeeze(injection_intensity(:,:,i)),size(TheColorImage_all,[1,2]));
end
%%
...
h3j = figure('Renderer', 'painters', 'Position', [100 100 600 400]);
...
axis image; axis off
%%
print(h3j, fullfile(save_folder,'Fig3j_AP_mean_activity_axon'),...
