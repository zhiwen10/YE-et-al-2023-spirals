function getSpiralsPrediction(T,data_folder,save_folder)
%%
for kk = 1:size(T,1)
    ...
    %% load dV from prediction folder instead
    load(fullfile(data_folder,'ephys','dv_prediction',...
        [fname '_dv_predict']));                                           % load dV from prediction folder instead
    ...
    %%
    fname2 = [fname '_spirals_predicted.mat'];
