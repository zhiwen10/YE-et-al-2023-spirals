function [hs12c,hs12d] = plotSpiralPredictionExample2(T,data_folder,save_folder)
...
hs12c = figure('Renderer', 'painters', 'Position', [100 100 1000 600]);
ax1 = subplot(3,4,1);
...
xlim([1,t_sample]);
ylim([0,1]);
print(hs12c, fullfile(save_folder,['FigS12c_' filename]),...
...
scale4 = 5/8;
frame_n = numel(frame);
hs12d = figure('Renderer', 'painters', 'Position', [100 100 800 400]);
for i = 1:numel(frame)   
...
print(hs12d, fullfile(save_folder,['FigS12d_' filename '_frames']),...
    '-dpdf', '-bestfit', '-painters');