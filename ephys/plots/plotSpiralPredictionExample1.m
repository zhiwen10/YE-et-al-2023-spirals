function [hs12a,hs12b] = plotSpiralPredictionExample1(T,data_folder,save_folder)
...
hs12a = figure('Renderer', 'painters', 'Position', [100 100 1000 600]);
ax1 = subplot(3,4,1);
...
xlim([1,t_sample]);
ylim([0,1]);
print(hs12a, fullfile(save_folder,['FigS12a_' filename]),...
...
scale4 = 5/8;
frame_n = numel(frame);
hs12b = figure('Renderer', 'painters', 'Position', [100 100 800 400]);
for i = 1:numel(frame)   
...
print(hs12b, fullfile(save_folder,['FigS12b_' filename '_frames']),...
    '-dpdf', '-bestfit', '-painters');