function [hs12e,hs12f] = plotWavePredictionExample1(T,data_folder,save_folder)
...
hs12e = figure('Renderer', 'painters', 'Position', [100 100 1000 600]);
ax1 = subplot(3,4,1);
...
xlim([1,t_sample]);
ylim([0,1]);
print(hs12e, fullfile(save_folder,['FigS12e_' filename]),...
...
scale4 = 5/8;
frame_n = numel(frame);
hs12f = figure('Renderer', 'painters', 'Position', [100 100 800 400]);
for i = 1:numel(frame)   
...
print(hs12f, fullfile(save_folder,['FigS12f_' filename '_frames']),...
    '-dpdf', '-bestfit', '-painters');