function h4g = plotSpiralsMatchingRate(T,data_folder,save_folder)
%%
...
ratio_all = {};
ratio_perm = {};
h4g = figure('Renderer', 'painters', 'Position', [100 100 600 300]);
count1 = 1;
...
%%
print(h4g,fullfile(save_folder, 'Fig4g_spirals_matching_ratio.pdf'),...
