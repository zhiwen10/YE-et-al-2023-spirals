function [k,predicted_signals,explained_var,predicted_signals_reduced] = ...
    AP_regresskernel_mod(regressors,signals,t_shifts,lambdas,zs,cvfold,return_constant,use_constant,discontinuities)
...
for curr_cv = 1:cvfold
    ...
    if cvfold == 1
        ...
        test_idx = [predictable_samples;true(size(ridge_matrix,1),1)];
    else
