function getPlaneWaveMirror2(data_folder,save_folder)
...
%     %
%     angle_all = {angle_MO_left;angle_MO_right;angle_SSp_left;angle_SSp_right};
%     figure;
%     for i = 1:4
%         subplot(1,4,i);
...
save(fullfile(save_folder,'flow_mirror_all2.mat'),'vxy_MO_left','vxy_MO_right',...
