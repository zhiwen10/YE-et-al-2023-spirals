function hr1b = plotWaveIndexAmp(data_folder,save_folder)
%%
...
hr1b = figure('Renderer', 'painters', 'Position', [50 50 250 350]);
...
print(hr1b, fullfile(save_folder,'FigR1b_planewave_index_vs_amp.pdf'),...
