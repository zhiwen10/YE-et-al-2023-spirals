function hs8k = plotExamplePlaneWaveSeries2(data_folder,save_folder)
...
%%
hs8k = figure('Renderer', 'painters', 'Position', [50 50 900 400]);
frame = 5;
lineColor = 'k';
hemi = [];
scale3 = 5/8;
...
%     overlayOutlines(coords,params.downscale);
    ...
    vxRaw2a(not(BW1)) = nan;
    vyRaw2a(not(BW1)) = nan;
    imH1Raw4 = quiver(vxRaw2a,vyRaw2a,'k','lineWidth',0.5,'autoScale','off');
    hold on;
    axis image; axis off;
    set(im1, 'AlphaData', BW1, 'AlphaDataMapping', 'scaled');
%     hold on;
...
%%
print(hs8k, fullfile(save_folder,'FigS8k_example_plane_wave.pdf'),...
