function hr1e = plotSymmetry3(data_folder,save_folder)
...
%%
hr1e = figure('Renderer', 'painters', 'Position', [50 50 700 400]);
%
plots = [3,4,2,4];
for k = 1:4
    if ismember(k,[3,4])
...
yticklabels({'-\pi','-\pi/2','0','\pi/2','\pi'});
%%
print(hr1e, fullfile(save_folder,'FigR1e_wave_symmetry.pdf'),...
