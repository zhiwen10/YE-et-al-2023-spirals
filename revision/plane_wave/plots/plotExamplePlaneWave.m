function hr1d = plotExamplePlaneWave(data_folder,save_folder)
...
%%
hr1d = figure('Renderer', 'painters', 'Position', [50 50 900 700]);
frame = 11;
lineColor = 'k';
hemi = [];
scale3 = 5/8;
...
print(hr1d, fullfile(save_folder,'FigR1d_wave_symmetry_example.pdf'),...
