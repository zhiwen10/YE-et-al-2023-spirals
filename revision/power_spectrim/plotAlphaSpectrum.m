function hr3d = plotAlphaSpectrum(T,data_folder,save_folder)
...
hr3d = figure('Renderer', 'painters', 'Position', [100 100 400 400]);
subplot(1,1,1);
...
%%
print(hr3d, fullfile(save_folder,'FigR3d_alpha_bump'),...
