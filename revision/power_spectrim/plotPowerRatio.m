function hr3c = plotPowerRatio(data_folder,save_folder)
%%
...
%%
hr3c = figure('Renderer', 'painters', 'Position', [100 100 300 300]);
index = ones(1,15);
...
%%
print(hr3c, fullfile(save_folder,'FigR3c_2-8hz_power_ratio'),...
