...
% axon_region_label = {"SSp-tr","SSp-ll","SSp-ul","SSp-m","SSp-n","SSp-bfd","VISp"};
...
for i = 1:7
    ...
    % [soma_all{i},axon_all{i}] = get_all_axon_in_area(st,av,allCoords,region_label,axon_st_cortex_indx,cell_limit);
    [soma_all{i},axon_all{i}] = get_all_axon_in_area3(st,av,allCoords,region_label,axon_st_cortex_indx);
end
color1 = hsv(7);
...
%     set(gca, 'YDir','reverse');
%     hold on;
%     scatter(ax2,center(1),center(2),20,'MarkerFaceColor',colors(i,:))
