...
% for k = 2
    ...
    [~,axon_terminal_all1] = get_axon_branching_by_neuron(cell_id,allCoords,av,anterior_indx, hemi_terminal);
    % get axon points for the left hemispheres in the entire cortex 
    [soma_all1,axon_points_all1,dendrite_all1] = get_axon_points_by_neuron(cell_id,allCoords,av,anterior_indx, hemi_terminal);
