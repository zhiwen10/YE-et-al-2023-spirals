...
for kk = 1:15
    ...
    filteredSpirals1 = filteredSpirals(filteredSpirals(:,3)>=80,:);
    ...
    vxRaw_mean = squeeze(vxRaw_mean); vyRaw_mean = squeeze(vyRaw_mean);
    vxRaw2 = nan(size(vxRaw)); vyRaw2 = nan(size(vyRaw));
    ...
    print(h, [fname '_mean_phase_flow'], '-dpdf', '-bestfit', '-painters');
    save([fname '_mean_phase_flow'],'spiral_phase_all_norm','spiral_phase_mean','vxRaw_all','vyRaw_all','vxRaw_mean','vyRaw_mean');
    close all;
end