function [soma_all,axon_all] = get_all_axon_in_area2(st,av,allCoords,region_label,cell_limit)
%%
% region_label = {"SSp-ll"};
...
if nargin==4 % if cell_limit is not specified 
    cell_limit = cell_id;
else 
...
for i = 1:numel(cell_id)
    ...
    axon_all = [axon_all;axonCoords_filt];
end
