...
%% MO
ffolder = 'C:\Users\Steinmetz lab\Documents\MATLAB\YE2023\cortex_regression\rrr_all\AP-3';
...
print(h1, 'AP-map-3', '-dpdf', '-bestfit', '-painters');


% LEFT TO RIGHT
ffolder = 'C:\Users\Steinmetz lab\Documents\MATLAB\YE2023\cortex_regression\rrr_all\hemi-3';
h1 = figure('Renderer', 'painters', 'Position', [100 100 600 800]);
...
print(h1, 'hemi-map-3', '-dpdf', '-bestfit', '-painters');
%%
count = 1;
